...
namespace GrafX_Quests
{
    ...
    /// </summary>
    public sealed partial class Graus_dos_Vertices : Page
    {
        int cont = 0;

        int Grau_de_A_Int = 3, Grau_de_B_Int = 3, Grau_de_C_Int = 3, Grau_de_D_Int = 5;
        public Graus_dos_Vertices()
        {
        ...
        public void Teste_de_Caminho_Euleriano()
        {
            cont++;
        ...
        {
            var Caixa_de_Mensagem = new MessageDialog("Delete pelo menos 2 arestas clicando nelas para continuar.", "Grafo Interativo");
